...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('metodo', models.CharField(choices=[('cartao', 'Cartão de Crédito/Débito'), ('pix', 'Pix'), ('dinheiro', 'Dinheiro'), ('outro', 'Outro')], max_length=20)),
                ('nome_no_cartao', models.CharField(blank=True, max_length=100, null=True)),
